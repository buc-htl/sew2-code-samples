...
/**
 In der Objektorientierung kennt man so genannte Zugriffsmodifizierer (engl. access modifier), die die Rechte
 anderer Objekte einschränken.

 Die (Daten)-Kapselung ist eine Strategie in der objektorientierten Programmierung um ungewollte Änderungen
 an Objekten von „außen“ zu verhindern und die Abhängigkeiten zwischen Klassen zu reduzieren.
 So sind einfacher Änderungen an einer Klasse möglich ohne Änderungen im gesamten Code vornehmen zu müssen.
 ...
 Klassenvariablen werden üblicherweise als private deklariert. Das Verändern der Variablen wird über passende Methoden,
 meist Getter und Setter ermöglicht. Damit erreichen wir eine (Daten)-Kapselung.
 ...
 Mit dem Zugriffsmodifizierer "protected" ist der Zugriff nicht nur Klassen aus demselben Package (wie "default"),
 sondern auch Subklassen der Klasse erlaubt. Dies gilt auch, wenn die betreffenden Subklassen aus einem anderen Package
 sind als die Klasse des betreffenden Members. Der Zugriffsmodifizierer "protected" wird verwendet, wenn es nur für
 Subklassen Sinn ergibt, den betreffenden Member zu verwenden.

 Der Zugriffsmodifizierer "public" gestattet sämtlichen Klassen Zugriff auf den betreffenden Member. Er ist
 der freizügigste Zugriffsmodifizierer. Die Zugreifbarkeit public findet man hauptsächlich bei Methoden, die von
 anderen Klassen verwendet werden sollen.
 **/
public class Bottle {
    ...
    Außerdem könnte man z.B. nicht einfach den Datentyp oder den Namen ändern, ohne dass überall im Code,
    wo auf diese Attribute zugegriffen wird, Änderungen vorgenommen werden müssen.
